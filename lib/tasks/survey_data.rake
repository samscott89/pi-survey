...
namespace :db do
  ...
  task populate_survey: :environment do
    ...
    q.option_group = OptionGroup.new(question_type: QuestionType.find_by(name: "collection_select"))
    ...
    q.save
      ...
      q.option_group = OptionGroup.new(question_type: QuestionType.multiples.shuffle.first)
      4.times do 
